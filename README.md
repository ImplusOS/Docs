# ImplusOS Documentation

Architecture references, refactor notes, license texts, and demonstration
images for [ImplusOS](https://github.com/ImplusOS).
...
See `Architecture/` for subsystem write-ups (kernel, VFS, network stack,
driver modules, boot sequence, ...) and `Others/` for in-progress TODOs.
